  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <!-- /.box-header -->
          <form role="form" action="<?=site_url('buysell/edit/'. $info['id']) ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="row">
                   ...
                   <div class="col-md-6">
                         <div class="form-group">
                          ...
                          <input type="text" name="ad_title" value="<?=$info['ad_title'];?>" class="form-control">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                         ...
                         <textarea name="req_details" class="form-control"><?=$info['req_details'];?></textarea>
                        </div>
                    </div>
                </div>
                 ...
                 <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" value="<?=$info['qty'];?>" name="qty" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" value="<?=$info['packaging_terms'];?>" name="packaging_terms" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                          <label for="flatOwnerID">Shipping Terms</label><br>
                          <input type="text" value="<?=$info['shipping_terms'];?>" name="shipping_terms" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                         ...
                         <input type="file" name="productImg" class="form-control">
                          <br>
						  <?php if(!empty($info['product_img'])){ ?>
							<img style="width:250px;" src="https://b2bitem.com/upload/buysell/<?=$info['product_img'];?>">
						  <?php } ?>
                        </div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <option value="">----Select----</option>
                            ...
                            <option <?=$inselected ;?> value="buy">Buy</option>
                        </select>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input required type="text" class="form-control datepicker" id="election_date" value="<?=$info['date'];?>"  name="date" autocomplete="off">
                    </div>
                   <div class="col-md-6">
                        <label for="name">Validity Date</label>
                        <input required type="text" class="form-control datepicker" id="election_date" value="<?=$info['validity_date'];?>" name="validity_date"  autocomplete="off">
                    </div>
                </div>

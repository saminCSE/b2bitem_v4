          ...
          <div class="box">
            ...
            <div class="box-body">
                <table id="minfo" border="1">
                    <tr>
                      <th colspan="4"> <h2 style="text-align: center;"><?=$info['company_name']?> <a class="btn btn-success btn-xs" target="_blank" style="font-size:12px; padding:5px;" href="<?=site_url('company/view/'. $info['company_id']);?>">View Company</a></h2> </th>
                    </tr>
                    <tr>
                      <th>Product Name</th>

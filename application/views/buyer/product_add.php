...
<div class="panel-body">
                  <div class="biz-card theme-space-box">
                     ...
                     <form method="post" action="<?=site_url('buyer/product_save');?>" enctype="multipart/form-data" id="productForm">
                        ...
                        <div class="product-form">
                           <div class="mb-4 mb-lg-5">
                              <div class="form-group row mb-3 mb-lg-4">
                                 ...
                                 <div class="col-lg-9">
                                    <input type="text" name="product_name" id="product_name" value="" placeholder="Enter Product Name" class="form-control char-count check-product-url">
                              ...
                              <div class="form-group row mb-3 mb-lg-4">
                                 ...
                                 <div class="col-lg-9 text-countable summernote-group">
                                    <textarea name="product_description" id="details" rows="5" placeholder="Product Details" class="form-control summernote"></textarea>
                              ...
                              <div class="form-group row mb-3 mb-lg-4">
                                 ...
                                 <div class="col-lg-9">
                                    <textarea rows="2" name="product_usage" id="product_usage" placeholder="Enter Product Usage / Application " class="form-control form-control-sm"></textarea>
                                 </div>
                              </div>
                              <div class="form-group row mb-3 mb-lg-4">
                                 ...
                                 <div class="col-lg-9">
                                    <textarea rows="2" name="product_keywords" id="product_keywords" placeholder="Enter Product Search Keywords" class="form-control form-control-sm"></textarea>
                                 </div>
                              </div>
                              <div class="form-group row mb-3 mb-lg-4">
                           ...
                           <div class="mb-4 mb-lg-5">
                              ...
                              <div class="form-group row mb-3 mb-lg-4">
                                 ...
                                 <div class="col-lg-9">
                                    <input type="text" name="certificate" id="certificate" value="" placeholder="Product Certification Info" class="form-control">
                                 </div>
                              </div>
                              <div class="form-group row mb-3 mb-lg-4">
                              ...
                              <div class="form-group row mb-3 mb-lg-4">
                                 ...
                                 <div class="col-lg-9">
                                    <div class="row small-gutters align-items-center">
                                       <div class="col-6 col-lg-5">
                                          <div>
                                             <input type="text" name="price" id="price_info" value="" min="1" placeholder="Price" class="form-control numeric-validation" data-allow-float="true" aria-errormessage="Price">
                                          </div>
                                       </div>
                                       <div class="col-6 col-lg-7">
                              ...
                              <div class="form-group row mb-3">
                                 ...
                                 <div class="col-lg-9">
                                    ...
                                    <div class="row sampleConditionInfo mt-2" style="display: none">
                                       <div class="col-xl-12 mb-2">
                                          <textarea name="sample_condition_info" id="sample_condition_info" class="form-control" placeholder="Sample Condition Information"></textarea>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="form-group row mb-3 mb-lg-4">
                                 ...
                                 <div class="col-lg-9">
                                    <input type="text" name="video" id="video" value="" placeholder="Product Video (Youtube URL)" class="form-control">
                                 </div>
                              </div>
                           ...
                           <div class="text-center offset-lg-3 px-0 mb-2">
                              <button type="submit" class="btn btn-b2bmap-secondary btn-md-down-small px-5">Submit</button>
                           </div>
                        </div>
                     </form>
                  </div>

                    ...
                    <div class="d-flex flex-grow-1">
                      ...
                      <div class="d-flex flex-column justify-content-center flex-grow-1 my-2 position-relative">
                        <div class="flex-nowrap doc-content business-license-form-content">
                          <form method="POST" action="<?=site_url('seller/save_company_name_file');?>" enctype="multipart/form-data" id="businessLicenseForm">
                    ...
                    <div class="d-flex flex-grow-1">
                      ...
                      <div class="d-flex flex-column justify-content-center flex-grow-1 my-2 position-relative">
                        <div class="doc-file d-block text-lg-right certification-file-form-content">
                          <form method="POST" action="<?=site_url('seller/save_company_name_file');?>" enctype="multipart/form-data" id="certificationFileForm">
                    ...
                    <div class="d-flex flex-grow-1">
                      ...
                      <div class="d-flex flex-column justify-content-center flex-grow-1 my-2 position-relative">
                        <div class="doc-file d-block text-lg-right telephone-bill-form-content">
                          <form method="POST" action="<?=site_url('seller/save_company_name_file');?>" enctype="multipart/form-data" id="uploadTelephoneBillForm">
                    ...
                    <div class="d-flex flex-grow-1">
                      ...
                      <div class="d-flex flex-column justify-content-center flex-grow-1 my-2 position-relative">
                        <div class="doc-file d-block text-lg-right bank-statement-form-content">
                          <form method="POST" action="<?=site_url('seller/save_company_name_file');?>" enctype="multipart/form-data" id="uploadBankStatementForm">

...
<div class="panel-body">
	<div>
		...
		<div class="mb-4">
				...
				<div class="row">
					...
					<div class="col-lg-5">
						<div class="form-group row align-items-center">
							...
							<div class="col-7">
								<form method="POST" action="<?= site_url('seller/update_company_logo'); ?>" enctype="multipart/form-data" id="uploadCompanyLogo">
			...
			<form method="post" action="<?= site_url('seller/update_profile'); ?>" enctype="multipart/form-data" class="biz-form">

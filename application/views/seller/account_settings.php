                  ...
                  <ul class="list-unstyled setting-list mb-0 error-list">
                      ...
                      <div class="border-bottom pb-3 pb-lg-2">
                        <div class="row">
                          ...
                          <div class="col-6 col-lg-3 text-right order-lg-last">
                            <a href="<?=site_url('seller/get_verified');?>" class="btn btn-sm btn-b2bmap-secondary py-0">Get Verified</a>
                          </div>
                    ...
                    <li>
                      ...
                      <div class="collapse" id="contactPersonCollapsable">
                        <div class="pt-3 pb-4">
                          <form action="<?=site_url('seller/save_contact_person_name');?>" method="POST" id="saveContactPersonName">
                    ...
                    <li>
                      ...
                      <div class="collapse" id="passwordCollapsable">
                        <div class="py-4">
                          <div class="row">
                            <div class="col-lg-9 offset-lg-3">
                              <form action="<?=site_url('seller/save_password');?>" method="post" id="changePassword" class="setting-form">

            ...
            <div class="row">
                      ...
                      <div>
						...
						<?php foreach($product_cat as $val){ ?>
                          <li class="nav-item aside-category-item">
                            <a href="<?=site_url('website/cat_wise_buyer/'. $val['link_prefix']);?>" class="aside-category-link"><?=$val['category_name'];?> </a>
                          </li>
						  <?php } ?>
                        </ul>
                      </div>
              ...
              <div class="col-lg-9">
                <div class="mb-4 mb-lg-5">
                  <div class="mb-3">
                    <h2 class="title-with-square-box">Latest Buying Leads - <?=$list[0]['category_name'];?> </h2>
                  </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6 col-xl-3 align-self-center">
                            <div class="pl-md-2 text-center">
                              <a href="<?=site_url('website/buysell/'.$val['offer_url']);?>" class="btn btn-b2bmap-primary btn-sm w-md-down-100 px-4">Contact Buyer</a>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <!--div class="mt-5 pagination-center">
                    <nav>
                      <ul class="pagination">
                        ...
                        <li class="page-item">
                          <a class="page-link" href="https://b2bmap.com/b2b-leads?page=2">2</a>
                        </li>
                        <li class="page-item">
                          <a class="page-link" href="https://b2bmap.com/b2b-leads?page=3">3</a>
                        </li>
                        <li class="page-item">
                          <a class="page-link" href="https://b2bmap.com/b2b-leads?page=4">4</a>
                        </li>
                        <li class="page-item">
                          <a class="page-link" href="https://b2bmap.com/b2b-leads?page=5">5</a>
                        </li>
                        <li class="page-item">
                          <a class="page-link" href="https://b2bmap.com/b2b-leads?page=6">6</a>
                        </li>
                        <li class="page-item">
                          <a class="page-link" href="https://b2bmap.com/b2b-leads?page=7">7</a>
                        </li>
                        <li class="page-item">
                          <a class="page-link" href="https://b2bmap.com/b2b-leads?page=8">8</a>
                        </li>
                        <li class="page-item">
                          <a class="page-link" href="https://b2bmap.com/b2b-leads?page=9">9</a>
                        </li>
                        <li class="page-item">
                          <a class="page-link" href="https://b2bmap.com/b2b-leads?page=10">10</a>
                        </li>
                        <li class="page-item disabled" aria-disabled="true">
                          <span class="page-link">...</span>
                        </li>
                        <li class="page-item">
                          <a class="page-link" href="https://b2bmap.com/b2b-leads?page=27">27</a>
                        </li>
                        <li class="page-item">
                          <a class="page-link" href="https://b2bmap.com/b2b-leads?page=28">28</a>
                        </li>
                        <li class="page-item">
                          <a class="page-link" href="https://b2bmap.com/b2b-leads?page=2" rel="next" aria-label="Next &raquo;">&rsaquo;</a>
                        </li>
                      </ul>
                    </nav>
                  </div-->

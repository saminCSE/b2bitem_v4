				...
				<div class="auth-input-group">
				  <div class="form-check-inline">
					<label class="form-check-label">
					  <input type="radio" <?php if($sesdata['company_user_type'] == 'Seller'){echo 'checked';}?>  required="required" name="company_user_type" value="Seller" class="form-check-input "> Seller </label>
				  </div>
				  <div class="form-check-inline">
					<label class="form-check-label">
					  <input type="radio" required="required" name="company_user_type"  <?php if($sesdata['company_user_type'] == 'Buyer'){echo 'checked';}?> value="Buyer" data-target="#businessTypeForBuyer" class="form-check-input"> Buyer </label>
				  </div>
				</div>
			  </div>
			</div>
